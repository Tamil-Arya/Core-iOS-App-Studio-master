...
{
    NSLog(@"Date Selected");
    if ([self.delegate respondsToSelector:@selector(dayPlannerView:didSelectEventOfType:atIndex:date:)]) {
        [self.delegate dayViewController:self didSelectdayAtDate:date];
    }
