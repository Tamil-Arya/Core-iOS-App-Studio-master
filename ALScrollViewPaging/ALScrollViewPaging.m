...
- (void)setHasPageControl:(BOOL)hasPageControl {
    ...
    if (hasPageControl) {
        ...
        int pageControlY = (self.frame.origin.y + self.frame.size.height)-30;
        ...
        [pageControl setPageIndicatorTintColor: [UIColor colorWithRed:245.0f/255.0f green:186.0f/255.0f blue:213.0f/255.0f alpha:1.0]];
         
        [pageControl setCurrentPageIndicatorTintColor:[UIColor colorWithRed:251.0f/255.0f green:6.0f/255.0f blue:120.0f/255.0f alpha:1.0]];
