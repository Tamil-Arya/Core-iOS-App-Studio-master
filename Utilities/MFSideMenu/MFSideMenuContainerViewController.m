...
- (void)setDefaultSettings {
    ...
    self.menuWidth =self.view.frame.size.width-150;
...
- (void)toggleRightSideMenuCompletion:(void (^)(void))completion {
    if(self.menuState == MFSideMenuStateRightMenuOpen) {
        ...
        self.menuContainerView.backgroundColor=[UIColor whiteColor];
...
//    UITabBarController *bar = self.centerViewController;
//    [bar.tabBar setBarTintColor:[[UIColor blackColor] colorWithAlphaComponent:0.5]];
//    
...
//    blurEffectView.frame = bar.selectedViewController.view.frame;
//    blurEffectView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
//    
//    
//    [bar.selectedViewController.view addSubview:blurEffectView];
...
//     UITabBarController *bar = _centerViewController;
//      [bar.tabBar setBarTintColor:[[UIColor whiteColor] colorWithAlphaComponent:1]];
//    
//    
//    UIViewController *contra = bar.selectedViewController;
//    for (UIView *vi in contra.view.subviews) {
//        if (vi.tag==420) {
