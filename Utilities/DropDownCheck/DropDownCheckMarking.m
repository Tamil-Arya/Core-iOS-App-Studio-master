...
- (id)initWithFrame:(CGRect)frame options:(NSArray*)items  selectedIndicies:(NSMutableArray*)indiciesSelected: (NSInteger)indexvalue;
{
    self = [super initWithFrame:frame];
    if (self) {
...
- (void)dropDownPressed:(id)sender
{
    ...
    [[NSUserDefaults standardUserDefaults]setValue:@"YES" forKey:@"Drop_view"];
...
-(void)moveTableUp
{
    ...
    [[NSUserDefaults standardUserDefaults]setValue:@"NO" forKey:@"Drop_view"];
    [[NSUserDefaults standardUserDefaults]synchronize];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([cellAtindexPath tag] == KUnselectedItemTag)
    {
        ...
        cellAtindexPath.accessoryType=UITableViewCellAccessoryCheckmark;
    ...
    else
    {
         ...
         cellAtindexPath.selectionStyle=UITableViewCellAccessoryNone;
