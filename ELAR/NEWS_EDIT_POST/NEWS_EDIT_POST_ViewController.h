//
//  NEWS_EDIT_POST_ViewController.h
//  ELAR
//
...
@interface NEWS_EDIT_POST_ViewController : UIViewController<UITextFieldDelegate,UITextViewDelegate,UIActionSheetDelegate,UIImagePickerControllerDelegate,UITableViewDataSource,UITableViewDelegate>
{
