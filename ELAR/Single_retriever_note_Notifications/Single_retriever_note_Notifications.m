//
//  Single_retriever_note_Notifications.m
...
@interface Single_retriever_note_Notifications ()

@end

@implementation Single_retriever_note_Notifications
...
//    
    ...
    //background
    backgroundBox  = [[UIView alloc] initWithFrame:CGRectMake(0, 64, self.view.frame.size.width, 1000)];
