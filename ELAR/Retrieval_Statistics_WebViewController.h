//
//  Retrieval_Statistics_WebViewController.h
...
@interface Retrieval_Statistics_WebViewController : UIViewController
{
    UIImageView * loader_image, * user_pic;
    NSString *loginUserId;
}
@property (strong, nonatomic) IBOutlet UIWebView *retrieval_StatisticsWebView;
