...
-(id)initWithTextField:(UITextField *)tf withData:(NSArray*) data
{
    ...
    if (self) {
		...
		self->toolbarDoneButtonText =[[NSBundle bundleWithPath:[[NSBundle mainBundle] pathForResource:[[NSUserDefaults standardUserDefaults]valueForKey:@"langugae"] ofType:@"lproj"]] localizedStringForKey:@"Done" value:@"" table:nil];
        self->toolbarCancelButtonText =[[NSBundle bundleWithPath:[[NSBundle mainBundle] pathForResource:[[NSUserDefaults standardUserDefaults]valueForKey:@"langugae"] ofType:@"lproj"]] localizedStringForKey:@"Cancel" value:@"" table:nil];
        ...
        self->textField.font = [Font_Face_Controller opensansLight:20];
    }
    return self;
}
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component
{
    ...
    [[NSUserDefaults standardUserDefaults]setValue:[NSString stringWithFormat:@"%ld",(long)row] forKey:@"index"];
...
-(void)doneClicked:(id) sender
{
    ...
    [[NSUserDefaults standardUserDefaults]setValue:textField.text forKey:@"group_view_selection"];
    [[NSUserDefaults standardUserDefaults]synchronize];
